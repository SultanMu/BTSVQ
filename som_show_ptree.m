function h=som_show_ptree(sMap, varargin)
...
for i=1:n,                         % main loop
  ...
  case 'comp'
    ...
    %y_label(i,1)=ylabel(sMap.comp_names{General.comp(i)}); Mujahid
  ...
  set(h_label,'Visible','on','verticalalignment','top','FontSize',6);
  %set(y_label,'Visible','on','verticalalignment','top','FontSize',6);
