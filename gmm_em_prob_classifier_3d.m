function [posteriors, posteriors_class] = gmm_em_prob_classifier_3d(K1,P1,K2,P2,sM1,sM2,X1,X2)
...
%$$$$$$$$$$$$$  added code
posteriors  = length(Pdm1(Pdm1>.6))/N1;
posteriors_class = length(Pdm2(Pdm2>.6))/N2;
