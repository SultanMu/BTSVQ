function [child] = p_tree_btsvq_classify_rank_oneu (sD, sM, level,filename)
                ...
                try, 
                    ...
                    if (level(i).child(j).data ~=[]) 
                        ...
                        if inds11 ~= [] & length(inds11)>1
                            ...
                            figure(6);
                            clf
                            subplot(3,2,3), plot (tt, '-r');
                            subplot(3,2,5), plot (pp, '-r');
                        ...
                        if inds12 ~= [] & length(inds12)>1
                            ...
                            try  % put this in try catch as some times the tt may get too smaller and we may get the out of dim error
                                ...
                                for ij = 1:length (inds12)
                                    ...
                                    tt(ij) = t./de;
                                    [h,p,ci,stats] = ttest2(sM0.codebook(inds12(ij),labels2),sM0.codebook(inds12(ij),labels1));
                                    pp(ij) = p;
                                end
